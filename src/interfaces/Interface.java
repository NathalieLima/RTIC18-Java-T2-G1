...
public class Interface {
	...
	public static void gestaoClientes() {
		...
		while (opcao_usuario != 0) {
			...
			switch (opcao_usuario) {
				...
				case 2:
					x.consultarCliente(cliente);
					break;

				case 3:
					x.listarCliente(cliente);
					break;

				case 4:
					x.excluirCliente(cliente);
					break;

				case 5:
					x.alterarCliente(cliente);
					break;
	...
	public static void gestaoImoveis() {
		int opcao_usuario = 1;
		Imovel x = new Imovel(null, null, null, null, 0, 0);
		Scanner entrada = new Scanner(System.in);
		ArrayList<String> lista_opcoes = new ArrayList<String>(
				List.of("Inserir", "Consultar", "Listar", "Excluir", "Alterar"));
	...
	public static void gestaoFaturas() {
		int opcao_usuario = 1;
		Fatura x = new Fatura(null, 0, 0, 0, false);
		Scanner entrada = new Scanner(System.in);
		ArrayList<String> lista_opcoes = new ArrayList<String>(
